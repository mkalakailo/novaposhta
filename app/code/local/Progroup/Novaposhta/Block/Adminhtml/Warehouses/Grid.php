<?php
class Progroup_Novaposhta_Block_Adminhtml_Warehouses_Grid extends Mage_Adminhtml_Block_Widget_Grid{
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('novaposhta/warehouses')->getCollection();
